...
To connect SimCenter applications and Jupyter notebooks in DesignSafe, it's essential to ensure that all required tools are accessible from both frameworks. SimCenter vision is well-aligned with this concept and offers all of the necessary functionality through backend applications installed in DesignSafe that can be accessed via Tapis apps. This isschematically shown in Fig X. Additionally, all SimCenter workflows are stored in JSON files that represent all steps in a workflow. This file is readily accesible using a JSON parser.

<p align="center">
<img src="./img/UC2-Arduino-1-1.png" alt="quoFEm in DesignSafe" width="600"/>
</p>
<p align="center"> <b>Fig.X - Running quoFEM analysis using remote computing resources at DesignSafe</b> </p>
